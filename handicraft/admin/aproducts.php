...
<main>
    ...
    <div class="wrapper1">
        <h1 style="color: #574a41">Products</h1>
        <div class="cate-body">
        ...
        foreach($products as $items)
        {
            ...
            <tr>
                ...
                <td style="padding: 0 5rem">
                    <img src="../images_bg/<?=$items['image']?>" width="100rem" height="100rem" alt="<?=$items['product_title'];?>">
                </td>
                <td>
                    <a href="edit_products.php?id=<?=$items['product_id'];?>" class="btn">Update</a>
                    <a href="edit_products.php?id=<?=$items['product_id'];?>" class="btn">Delete</a>
                </td>
            </tr>
            <?php
        }
